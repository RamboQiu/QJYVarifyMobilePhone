...
- (BOOL)isValidPhoneNumber {
    ...
    /**
     ...
     11         * 134[0-8],135,136,137,138,139,140,147,150,151,152,157,158,159,178,182,183,184,187,188,1705
     12         */
    NSString * CM = @"^1(34[0-8]|705|(3[5-9]|4[07]|5[0127-9]|78|8[23478])\\d)\\d{7}$";
    /**
     15         * 中国联通：China Unicom
     16         * 130,131,132,141,143,145,152,155,156,185,186,175,176,1709
     17         */
    NSString * CU = @"^1(709|(3[0-2]|4[135]|5[256]|8[56]|7[56])\\d)\\d{7}$";
    /**
     20         * 中国电信：China Telecom
     21         * 133,1349,142,144,146,148,149,153,177,180,181,189,1700
     22         */
